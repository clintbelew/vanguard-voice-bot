...
def get_audio_url_from_filename(filename):
    """
    Generate a clean, direct URL for an audio file using PUBLIC_URL_BASE.
    This replaces the problematic normalize_url function with a simple, direct approach.
    """
    # Ensure PUBLIC_URL_BASE doesn't have trailing slashes
...
def get_cached_audio_url(text, language="en-US"):
    ...
    if os.path.exists(cache_file):
        ...
        return get_audio_url_from_filename(encoded_filename)
