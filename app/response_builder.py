...
def validate_url(url):
    ...
    This is a second layer of validation in case the elevenlabs_integration validation fails.
    """
    if not url:
        return url
...
def sanitize_twiml(twiml_response):
    ...
    Args:
        twiml_response (str): The TwiML response string
        
    Returns:
        str: The sanitized TwiML response string
    """
