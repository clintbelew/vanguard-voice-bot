...
def handle_appointment_booking(response, speech_input=None):
    ...
    try:
        ...
        # Fallback response
        response.say("I'm having trouble with our scheduling system. Let me connect you with our staff who can help schedule your appointment.", voice='Polly.Joanna')
        return response
...
def handle_appointment_rescheduling(response, speech_input=None):
    ...
    try:
        ...
        # Fallback response
        response.say("I'm having trouble with our scheduling system. Let me connect you with our staff who can help reschedule your appointment.", voice='Polly.Joanna')
        return response
