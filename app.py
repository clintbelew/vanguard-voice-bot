...
def twilio_voice_hyphen():
    """Handle incoming phone calls and return TwiML (hyphen version)."""
    print("Twilio call received at /twilio-voice endpoint")
    logger.info("Twilio-voice endpoint called (hyphen version)")
    ...
    try:
        ...
        logger.error(f"Error in voice-hyphen route: {str(e)}")
